...
def load_data(uploaded_file=None):
    """Loads loan data from upload or fallback CSV.
    Cleans it and caches for performance."""
...
def Home_Page():
    ...
    | George Owell             | 22256146   | Model Evaluation & Cross-validation         | https://loandefaultpredictionapp-utmbic9znd7uzqqhs9zgo6.streamlit.app/ |
